...
public class GostResourceIntTest {
    ...
    public void createGost() throws Exception {
        ...
        assertThat(testGost.getLogin()).isEqualTo(DEFAULT_LOGIN);
        assertThat(testGost.getPassword()).isEqualTo(DEFAULT_PASSWORD);
    ...
    public void updateGost() throws Exception {
        ...
        Gost testGost = gostList.get(gostList.size() - 1);
        assertThat(testGost.getLogin()).isEqualTo(UPDATED_LOGIN);
        assertThat(testGost.getPassword()).isEqualTo(UPDATED_PASSWORD);
