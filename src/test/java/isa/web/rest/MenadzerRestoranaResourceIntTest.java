...
public class MenadzerRestoranaResourceIntTest {
    ...
    public void createMenadzerRestorana() throws Exception {
        ...
        assertThat(testMenadzerRestorana.getLogin()).isEqualTo(DEFAULT_LOGIN);
        assertThat(testMenadzerRestorana.getPassword()).isEqualTo(DEFAULT_PASSWORD);
    ...
    public void updateMenadzerRestorana() throws Exception {
        ...
        MenadzerRestorana testMenadzerRestorana = menadzerRestoranaList.get(menadzerRestoranaList.size() - 1);
        assertThat(testMenadzerRestorana.getLogin()).isEqualTo(UPDATED_LOGIN);
        assertThat(testMenadzerRestorana.getPassword()).isEqualTo(UPDATED_PASSWORD);
