...
public class ZaposleniResourceIntTest {
    ...
    public void createZaposleni() throws Exception {
        ...
        assertThat(testZaposleni.getLogin()).isEqualTo(DEFAULT_LOGIN);
        assertThat(testZaposleni.getPassword()).isEqualTo(DEFAULT_PASSWORD);
    ...
    public void updateZaposleni() throws Exception {
        ...
        Zaposleni testZaposleni = zaposleniList.get(zaposleniList.size() - 1);
        assertThat(testZaposleni.getLogin()).isEqualTo(UPDATED_LOGIN);
        assertThat(testZaposleni.getPassword()).isEqualTo(UPDATED_PASSWORD);
