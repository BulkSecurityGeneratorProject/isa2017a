(function() {
    ...
    RezervacijaDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Rezervacija', 'Stol', 'Porudzbina', 'Poziv', 'Restoran', 'Gost'];

    function RezervacijaDialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Rezervacija, Stol, Porudzbina, Poziv, Restoran, Gost) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('isaApp:rezervacijaUpdate', result);
