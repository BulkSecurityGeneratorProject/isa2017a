...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(isa.domain.Gost.class.getName() + ".poslaoPozivs", jcacheConfiguration);
            ...
            cm.createCache(isa.domain.Rezervacija.class.getName() + ".zaRezervacijus", jcacheConfiguration);
            cm.createCache(isa.domain.Poziv.class.getName(), jcacheConfiguration);
