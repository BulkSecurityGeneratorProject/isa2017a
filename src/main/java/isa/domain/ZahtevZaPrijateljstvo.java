...
public class ZahtevZaPrijateljstvo implements Serializable {
    ...
    private Long idPodnosiocaZahteva;
    ...
    public Long getIdPodnosiocaZahteva() {
        return idPodnosiocaZahteva;
    }

    public ZahtevZaPrijateljstvo idPodnosiocaZahteva(Long idPodnosiocaZahteva) {
        this.idPodnosiocaZahteva = idPodnosiocaZahteva;
        return this;
    }

    public void setIdPodnosiocaZahteva(Long idPodnosiocaZahteva) {
        this.idPodnosiocaZahteva = idPodnosiocaZahteva;
    }
