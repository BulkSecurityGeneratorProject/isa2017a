...
public class Gost implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Poziv> poslaoPozivs = new HashSet<>();
    ...
    public Gost login(String login) {
        this.login = login;
        return this;
    }
    ...
    public Gost password(String password) {
    ...
    public Set<Poziv> getPoslaoPozivs() {
        return poslaoPozivs;
    }

    public Gost poslaoPozivs(Set<Poziv> pozivs) {
        this.poslaoPozivs = pozivs;
        return this;
    }

    public Gost addPoslaoPoziv(Poziv poziv) {
        this.poslaoPozivs.add(poziv);
        poziv.setGost(this);
        return this;
    }

    public Gost removePoslaoPoziv(Poziv poziv) {
        this.poslaoPozivs.remove(poziv);
        poziv.setGost(null);
        return this;
    }

    public void setPoslaoPozivs(Set<Poziv> pozivs) {
        this.poslaoPozivs = pozivs;
    }
