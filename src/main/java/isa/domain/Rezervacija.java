...
public class Rezervacija implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Poziv> zaRezervacijus = new HashSet<>();
    ...
    public Set<Poziv> getZaRezervacijus() {
        return zaRezervacijus;
    }

    public Rezervacija zaRezervacijus(Set<Poziv> pozivs) {
        this.zaRezervacijus = pozivs;
        return this;
    }

    public Rezervacija addZaRezervaciju(Poziv poziv) {
        this.zaRezervacijus.add(poziv);
        poziv.setRezervacija(this);
        return this;
    }

    public Rezervacija removeZaRezervaciju(Poziv poziv) {
        this.zaRezervacijus.remove(poziv);
        poziv.setRezervacija(null);
        return this;
    }

    public void setZaRezervacijus(Set<Poziv> pozivs) {
        this.zaRezervacijus = pozivs;
    }
